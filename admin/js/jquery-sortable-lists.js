/*
 |  jQuery.sortabkeLists - Sort HTML lists and also the Tree structures.
 |  @file       ./jquery-sortable-lists.js
 |  @author     Vladimír Čamaj
 |  @version    1.4.1-fork
 |
 |  @website    https://github.com/camohub/jquery-sortable-lists
 |  @license    X11 / MIT License
 |  @copyright  Copyright © 2015 - 2019 Vladimír Čamaj
 */
(function($){
	...
	$.fn.sortableListsToHierarchy = function()
	{
		...
		$( this ).children( 'li' ).each( function()
		{
			...
			listItem.type = li.find("input[name='type']").val();
			listItem.title = li.find("input[name='name']").val();
            arr[li.find("input[name='slug']").val()] = listItem;
